...
y1_interp = interp1(x, y1, x_new,"pchip","extrap");
y2_interp = interp1(x, y2, x_new,"pchip","extrap");
y3_interp = interp1(x, y3, x_new,"pchip","extrap");
pchip_interp = [x_new; y1_interp; y2_interp; y3_interp]';
...
pchip_interp_cpp = importdata("..\resource\test_result\interp\pchip_interp_all.txt");
...
hold on;
plot(x_exact, y1_exact, 'k-', 'DisplayName', 'Exact y1');
plot(x_new, pchip_interp(:,2), 'ro-', 'DisplayName', 'MATLAB PCHIP y1');
plot(x_new, pchip_interp_cpp(:,2), 'bx--', 'DisplayName', 'C++ PCHIP y1');
legend; grid on; title('PCHIP Interpolation Comparison for y1');
...
hold on;
plot(x_exact, y2_exact, 'k-', 'DisplayName', 'Exact y2');
plot(x_new, pchip_interp(:,3), 'ro-', 'DisplayName', 'MATLAB PCHIP y2');
plot(x_new, pchip_interp_cpp(:,3), 'bx--', 'DisplayName', 'C++ PCHIP y2');
legend; grid on; title('PCHIP Interpolation Comparison for y2');
...
hold on;
plot(x_exact, y3_exact, 'k-', 'DisplayName', 'Exact y3');
plot(x_new, pchip_interp(:,4), 'ro-', 'DisplayName', 'MATLAB PCHIP y3');
plot(x_new, pchip_interp_cpp(:,4), 'bx--', 'DisplayName', 'C++ PCHIP y3');
legend; grid on; title('PCHIP Interpolation Comparison for y3');